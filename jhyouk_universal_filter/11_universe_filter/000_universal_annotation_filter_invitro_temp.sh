...
(python /home/users/jhyouk/81_filter_test_LADC/11_universe_filter/02_AddNpanelToVCF_"$2".py $1_$2_union_2.readinfo.readc.rasmy.vcf $6 PanelofNormal) &>> $log || { c=$?;echo "Error";exit $c; }
echo "done" >>$log
