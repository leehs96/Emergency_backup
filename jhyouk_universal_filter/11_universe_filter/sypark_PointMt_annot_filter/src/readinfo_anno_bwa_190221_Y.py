...
while in_line:
	if in_line[0:4]=='#CHR':
		out_file.write(in_line+'\tref_readN\tvar_readN\tref_medMQ\tvar_medMQ\tvar_LocaLeftMin;Med;Max\tvar_LocaRightMin;Med;Max\trefClip;pct;varClip;pct\trefIns;pct;varIns;pct\trefDel;pct;varDel;pct\tref_medMismatch\tvar_medMismatch\n')
	elif in_line[0]=='#':
