...
(sh /home/users/jhyouk/81_filter_test_LADC/11_universe_filter/sypark_PointMt_annot_filter/PointMt_annot_cov2.sh $1_$2_union_2.vcf $4 $5 /home/users/jhyouk/81_filter_test_LADC/11_universe_filter/sypark_PointMt_annot_filter/src $3) &>> $log || { c=$?;echo "Error";exit $c; }
echo "done" >>$log
